...
@Component({
  selector: 'app-agregar-necesidad-agropecuarios',
  templateUrl: './agregar-necesidad-agropecuarios.component.html',
  styleUrls: ['./agregar-necesidad-agropecuarios.component.scss']
})
export class AgregarNecesidadAgropecuariosComponent implements OnInit {
  ...
  agregarNecesidad() {
    const data: Necesidades = {
      idTipoNecesidad: 4,
      tipoNecesidad: 'NECESIDAD PARA LA ATENCIÓN AGROPECUARIA',
