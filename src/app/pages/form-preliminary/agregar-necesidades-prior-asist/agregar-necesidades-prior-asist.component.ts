...
@Component({
  selector: 'app-agregar-necesidades-prior-asist',
  templateUrl: './agregar-necesidades-prior-asist.component.html',
  styleUrls: ['./agregar-necesidades-prior-asist.component.scss']
})
export class AgregarNecesidadesPriorAsistComponent implements OnInit {
  ...
  agregarNecesidad() {
    const data: Necesidades = {
      idTipoNecesidad: 1,
      tipoNecesidad: 'NECESIDAD PRIORITARIAS DE ASISTENCIA HUMANITARIA',
